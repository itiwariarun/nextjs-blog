  ...
  return (
    <>
      <div className="flex items-center justify-between gap-5 pt-12">
        ...
        <div className="flex flex-col gap-y-4">
          <a
            ...
            className="flex items-center hover:underline underline-offset-2 gap-2.5 text-xs font-medium text-gray-700 md:text-sm"
          >
            Linkedin
            <ArrowUpIcon />
          </a>
          <a
            ...
            className="flex items-center gap-2.5 hover:underline underline-offset-2 text-xs font-medium text-gray-700 md:text-sm"
          >
            Github
            <ArrowUpIcon />
          </a>
      ...
      <div className="flex items-center justify-between gap-5 pb-10">
        ...
        <div className="flex items-center gap-5 text-xs font-normal text-gray-600 md:text-sm">
          <p>Privacy Policy</p>
